...
var handlers = map[string]handlerFunc{
	...
	"reflog.get":               handleReflogGet,
	"reflog.restore":           handleReflogRestore,
	...
	"commit.delete_file":       handleCommitDeleteFile,
	...
	"workdir.unignore":         handleWorkdirUnignore,
	"workdir.dfmignore.get":    handleWorkdirDfmignoreGet,
	"workdir.dfmignore.set":    handleWorkdirDfmignoreSet,
