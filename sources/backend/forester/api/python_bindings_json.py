...
class ForesterAPI:
    ...
    def drop(self, repo_path: str, files: List[str]) -> Dict[str, Any]:
        return self._call(repo_path, "index.drop", {"files": files})
    ...
    def reflog(self, repo_path: str, ref: str = "", limit: int = 100) -> Dict[str, Any]:
        result = self._call(repo_path, "reflog.get", {"ref": ref, "limit": limit})
        return {"success": True, "entries": result.get("entries", [])}

    def restore_commit(self, repo_path: str, commit_hash: str) -> Dict[str, Any]:
        return self._call(repo_path, "reflog.restore", {"commit_hash": commit_hash})
    ...
    def delete_file_from_commit(self, repo_path: str, commit_hash: str, path: str) -> Dict[str, Any]:
        return self._call(repo_path, "commit.delete_file", {"commit_hash": commit_hash, "path": path})
