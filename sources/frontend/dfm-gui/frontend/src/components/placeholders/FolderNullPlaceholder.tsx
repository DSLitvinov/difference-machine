...
export function FolderNullPlaceholder({ locale }: { locale: Locale }) {
  const copy = t(locale);
  return (
    <div className="flex w-full flex-1 flex-col items-center justify-center gap-2 p-3">
      <ThemeImg src={asset("illustrations/folder-null.svg")} alt="" width={128} height={128} className="size-32 object-contain" />
