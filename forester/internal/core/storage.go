...
// This is a utility function for working with tree structures in Forester
func BuildTreeMapRecursive(storage *Storage, tree *models.Tree, prefix string, treeMap map[string]*models.TreeEntry) {
