...
**Текущий статус:** v1/v1.1 и v2 feature scope закрыты: macOS smoke, Merge UI, fs watcher, Detached HEAD, rename `R`, branch delete, init wizard. Активно: Windows smoke и Linux build/QA ([implementation-plan-v2.md](./implementation-plan-v2.md)).
