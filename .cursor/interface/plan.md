...
**v2:** macOS smoke **закрыт** · Merge UI · Fs watcher · Detached HEAD · rename `R` **закрыты** ([implementation-plan-v2.md](./implementation-plan-v2.md) фаза 6) · активная фаза **7** (branch delete). Далее: Windows/Linux build.
