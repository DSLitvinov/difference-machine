...
**v2:** macOS smoke **закрыт** · Merge UI · Fs watcher · Detached HEAD · rename `R` · branch delete **закрыты** ([implementation-plan-v2.md](./implementation-plan-v2.md) фаза 7). Далее: Windows/Linux build, init wizard (backlog).
