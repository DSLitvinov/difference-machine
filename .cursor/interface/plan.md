...
**v2:** macOS smoke **закрыт** · Merge UI · Fs watcher · Detached HEAD · rename `R` · branch delete · init wizard **закрыты** ([implementation-plan-v2.md](./implementation-plan-v2.md) фаза 8). Далее: Windows/Linux build.
