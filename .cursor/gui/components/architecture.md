...
| Immutable art — `assets/{light,dark}/{brand,placeholders,file-types,previews}/` | Подменять placeholder Lucide |

Chrome-иконки через Lucide (`currentColor` с родителя). `Icon` не задаёт `text-foreground` сам: цвет — у кнопки / текста. Иллюстрации (brand, placeholders, file-types, previews) — статические файлы в light/dark; резолв через `asset()`.
...
|---------|-----|----------------|
| Default (primary) | `Background/primary/default` `#18181b` (в dark — инверсия токена) | `Foreground/primary/default` |
...
Стаб пропавшего файла в сетке — [grid-file](./items/grid-file.md), `Icons / 256 / File / Missing` (`6066:12434`), `file-types/missing.svg`.
...
| Item / Commit / Diff / Binary Diff | `6067:13830` | [items/commit-diff-binary.md](./items/commit-diff-binary.md) |
...
| Popover (Folder Preview Item) | — | [popovers/folder-preview-item.md](./popovers/folder-preview-item.md) |
...
| Popover (Branch) | `6050:12558` | [items/header-select-branch.md](./items/header-select-branch.md) |
| Popover (Manage branches) | `6050:12559` | [items/header-select-branch.md](./items/header-select-branch.md) |
...
| Content / Placeholder / Missing file | `6067:13517` | [placeholders/missing-file.md](./placeholders/missing-file.md) |
| Content / Placeholder / Damaged | в `6078:16278` | [placeholders/damaged.md](./placeholders/damaged.md) |
...
Модалки: [../dialogs/architecture.md](../dialogs/architecture.md) ([файлы](../dialogs/files.md), [restore](../dialogs/restore.md), [обслуживание](../dialogs/maintenance.md)).
