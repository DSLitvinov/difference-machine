...
Как сетка Max+Lock: letter слева снизу, lock справа снизу (top 276, letter ~left 12, lock left 276). Оба — FileStatusBadge. Нет статуса — не рисовать letter. `ignored` → **i** вместо A/M/N/D/R.
