...
Img: масштаб **без chrome**. **Ctrl** или **Cmd** + колесо / жест тачпада — зум картинки (0.25…8 от вписанного размера). Скролл без модификатора — пан, если кадр больше области. Смена файла сбрасывает зум. Не зумить окно WebView.
