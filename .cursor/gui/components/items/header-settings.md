...
| Help | [`4335:20065`](https://www.figma.com/design/qlwKiMPZblz96VSM2F3DlS/DFM-for-Cursor?node-id=4335-20065) | 40×40, ghost icon `circle-help` | справка, **пока не активна** |
...
Видна, как в макете (`State=Default`). **Не активна:** клик ничего не делает, диалог и URL не открывать. Не скрывать. Не добавлять tooltip «coming soon» и disabled-стиль, которого нет в наборе.
