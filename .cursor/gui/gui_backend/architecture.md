...
| Превью картинки/видео/blend/текста | сетка и File Info: `workdir.thumbnail`; Content View файла: `workdir.file` только для растра; ревизия: `blob.get`; кэш — [thumbnails.md](./thumbnails.md) |
