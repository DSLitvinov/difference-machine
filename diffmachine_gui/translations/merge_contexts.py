...
RU_FALLBACK = {
    ...
    "Optional author name": "Необязательное имя автора", "Tag": "Тег", "Optional tag name": "Необязательное имя тега",
...
EN_FALLBACK = {
    ...
    "Optional author name": "Optional author name", "Tag": "Tag", "Optional tag name": "Optional tag name",
...
def main():
    ...
    context_ts = base / "diffmachine_contexts.ts"
    ru_map = parse_source_to_translation(base / "diffmachine_ru.ts")
    en_map = parse_source_to_translation(base / "diffmachine_en.ts")
    ...
    for lang, trans_map, name in [("ru", ru_map, "diffmachine_ru.ts"), ("en", en_map, "diffmachine_en.ts")]:
